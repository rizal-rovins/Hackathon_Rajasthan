...
package june.seven.ark.fourpointzero.samples.VuforiaSamples.app.CloudRecognition;
...
import june.seven.ark.fourpointzero.samples.SampleApplication.utils.LoadingDialogHandler;
import june.seven.ark.fourpointzero.samples.SampleApplication.utils.SampleApplicationGLView;
import june.seven.ark.fourpointzero.samples.SampleApplication.utils.Texture;
import june.seven.ark.fourpointzero.samples.VuforiaSamples.ui.SampleAppMenu.SampleAppMenu;
import june.seven.ark.fourpointzero.samples.VuforiaSamples.ui.SampleAppMenu.SampleAppMenuGroup;
import june.seven.ark.fourpointzero.samples.VuforiaSamples.ui.SampleAppMenu.SampleAppMenuInterface;
    ...
    SampleAppMenuInterface
{
    ...
    private static final String kAccessKey = "b288915ca28a2a37a4e8dedf9ed85a14a5722fb5";
    private static final String kSecretKey = "80fa4a2f5ae3af907c1fc50a94d0fc29544584f6";
    ...
    public boolean doStopTrackers()
    {
        ...
        if(objectTracker != null)
        {
            ...
            TargetFinder targetFinder = objectTracker.getTargetFinder();
            Log.d("ObjectTracker:00000",objectTracker.toString());
            targetFinder.stop();
            scanlineStop();
            mFinderStarted = false;
